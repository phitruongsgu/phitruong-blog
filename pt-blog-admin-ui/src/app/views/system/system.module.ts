...
import { PTSharedModule } from 'src/app/shared/modules/pt-shared.module';
...
@NgModule({
  ...
  declarations: [UserComponent, RoleComponent, RoleDetailComponent, PermissionGrantComponent, ChangeEmailComponent,
    RoleAssignComponent,
